...
UCLASS()
class AON_API ASkillUnitTargetActor : public AActor
{
...
public:	
	...
	void OnStart(class ABasicUnit* caster, class ABasicUnit* target);
	// 擊中目標
	UFUNCTION(BlueprintImplementableEvent, Category = "MOBA")
	...
	// 被閃避
	UFUNCTION(BlueprintImplementableEvent, Category = "MOBA")
	void BeDodge(class ABasicUnit* caster, class ABasicUnit* target);
	...
	class ABasicUnit* LastTarget = nullptr;

	class ABasicUnit* CheckLastTarget = nullptr;
