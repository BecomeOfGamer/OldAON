...
public:
	...
	IEWebBrowserWindow::FOnBeforePopupDelegate& OnBeforePopup()
	{
		return BeforePopupDelegate;
	}

	IEWebBrowserWindow::FOnCreateWindow& OnCreateWindow()
	{
...
private:
	...
	IEWebBrowserWindow::FOnBeforePopupDelegate BeforePopupDelegate;
