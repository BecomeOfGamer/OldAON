...
public:
	 ...
	 */
	void AddSchemeHandlerFactory(FString Scheme, FString Domain, IEWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory);
	 ...
	 */
	void RemoveSchemeHandlerFactory(IEWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory);
