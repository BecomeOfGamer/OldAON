...
public:
	...
	virtual EEWebBrowserDocumentState GetDocumentLoadingState() const override;
...
private:
	 ...
	 */
	bool RequestCreateWindow(const TSharedRef<IEWebBrowserWindow>& NewBrowserWindow, const TSharedPtr<IEWebBrowserPopupFeatures>& BrowserPopupFeatures);

	//bool SupportsCloseWindows();
	//bool RequestCloseWindow(const TSharedRef<IEWebBrowserWindow>& BrowserWindow);
...
private:
	...
	EEWebBrowserDocumentState DocumentState;
