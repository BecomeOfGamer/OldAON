 ...
 * It will be created by implementing an IEWebBrowserSchemeHandlerFactory, given to the web browser singleton.
 */
class WEBBROWSEREXTENSION_API IEWebBrowserSchemeHandler
{
public:
	/**
...
public:
	virtual ~IEWebBrowserSchemeHandler() {}
 ...
 */
class WEBBROWSEREXTENSION_API IEWebBrowserSchemeHandlerFactory
{
public:
	virtual ~IEWebBrowserSchemeHandlerFactory() {}
	 ...
	 * @param   Url             This is the full url for the request being made.
	 */
	virtual TUniquePtr<IEWebBrowserSchemeHandler> Create(FString Verb, FString Url) = 0;
};
