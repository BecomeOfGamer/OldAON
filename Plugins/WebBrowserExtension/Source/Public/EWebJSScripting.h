...
{
public:
	FEWebJSScripting(bool bInJSBindingToLoweringEnabled)
	...
	virtual void InvokeJSFunction(FGuid FunctionId, int32 ArgCount, FEWebJSParam Arguments[], bool bIsError=false) =0;
