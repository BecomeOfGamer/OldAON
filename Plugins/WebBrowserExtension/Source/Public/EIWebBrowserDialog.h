...
enum class EEWebBrowserDialogType
{
...
enum class EEWebBrowserDialogEventResponse
{
	...
	Ignore,
	/** The event handler will take care of showing the dialog. It must call IEWebBrowserDialog::Continue once it has been dismissed. */
	Handled,
};
...
public:
	 ...
	 */
	virtual EEWebBrowserDialogType GetType() = 0;

	/**
	 * Tell the browser to continue with the result of the dialog.
	 * If this method is used, the original event handler must return EEWebBrowserDialogEventResponse::Handled.
	 *
