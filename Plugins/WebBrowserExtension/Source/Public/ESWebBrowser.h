...
class WEBBROWSEREXTENSION_API ESWebBrowser
	: public SCompoundWidget
{
public:
	DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnBeforeBrowse, const FString&, const FEWebNavigationRequest& /*Request*/)
...
private:
	...
	TSharedPtr<ESWebBrowserView> BrowserView;
