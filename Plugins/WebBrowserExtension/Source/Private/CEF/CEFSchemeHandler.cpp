...
class FHandlerHeaderSetter
	: public IEWebBrowserSchemeHandler::IHeaders
{
public:
...
{
public:
	FCefSchemeHandler(TUniquePtr<IEWebBrowserSchemeHandler>&& InHandlerImplementation)
...
private:
	TUniquePtr<IEWebBrowserSchemeHandler> HandlerImplementation;
...
public:
	...
	FCefSchemeHandlerFactory(IEWebBrowserSchemeHandlerFactory* InWebBrowserSchemeHandlerFactory)
	...
	bool IsUsing(IEWebBrowserSchemeHandlerFactory* InWebBrowserSchemeHandlerFactory)
	{
		return WebBrowserSchemeHandlerFactory == InWebBrowserSchemeHandlerFactory;
	}

private:
	IEWebBrowserSchemeHandlerFactory* WebBrowserSchemeHandlerFactory;
