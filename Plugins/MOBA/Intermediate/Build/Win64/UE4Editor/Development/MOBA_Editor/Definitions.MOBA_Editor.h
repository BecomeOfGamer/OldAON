...
#define ORIGINAL_FILE_NAME "UE4Editor-MOBA_Editor.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME AON
#define DEPRECATED_FORGAME DEPRECATED
#define MOBA_EDITOR_API DLLEXPORT
