...
// End Cross Module References
	...
	void AMOBAPlayerController::ServerHeroUseSkill(AHeroCharacter* hero, EHeroActionStatus SpellType, int32 index, FVector VFaceTo, FVector Pos, AHeroCharacter* victim)
	{
	...
	UFunction* Z_Construct_UFunction_AMOBAPlayerController_ServerHeroUseSkill()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_victim = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("victim"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(victim, MOBAPlayerController_eventServerHeroUseSkill_Parms), 0x0010000000000080, Z_Construct_UClass_AHeroCharacter_NoRegister());
			UProperty* NewProp_Pos = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Pos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Pos, MOBAPlayerController_eventServerHeroUseSkill_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_VFaceTo = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("VFaceTo"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(VFaceTo, MOBAPlayerController_eventServerHeroUseSkill_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			...
			UProperty* NewProp_SpellType = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("SpellType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(SpellType, MOBAPlayerController_eventServerHeroUseSkill_Parms), 0x0010000000000080, Z_Construct_UEnum_MOBA_EHeroActionStatus());
	...
	UClass* Z_Construct_UClass_AMOBAPlayerController()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AMOBAPlayerController_ServerHeroUseSkill(), "ServerHeroUseSkill"); // 128151171
	...
	IMPLEMENT_CLASS(AMOBAPlayerController, 1333801323);
